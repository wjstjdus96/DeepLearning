...
#### 기존 계획
학습 데이터셋을 수집하고 모델을 학습시켜 젯봇이 스스로 길을 따라가는 로드 팔로잉 기능과 장애물이 있는 경우에는 멈췄다가 장애물이 사라졌을 때 다시 길을 갈 수 있게 하는 충돌회피 기능을 갖출 수 있게 한다.

#### 문제점
학습된 모델로 충돌 회피를 테스트 하는 과정에서 카메라가 정상적으로 작동하지 않아 동일한 에러가 계속 발생하였다.

#### 최종 결과
로드 팔로잉 기능만 갖춘 젯봇을 만들게 되었다.
